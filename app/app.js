...
let allItems=[], categories=[], groups=[];
  ...
  function _onbDocLang() {
    if (_onbLang === 'en' || _onbLang === 'fr') return _onbLang;
    if (_onbDisplayedLang === 'en' || _onbDisplayedLang === 'fr') return _onbDisplayedLang;
  ...
  function _updateOnbLangDisplay(displayLang) {
    _onbDisplayedLang = displayLang === 'en' ? 'en' : 'fr';
    const txt = _ONB_TEXTS[_onbDisplayedLang] || _ONB_TEXTS.fr;
  ...
  function showOnboarding() {
    _onbStep = 0;
    _onbLang = null;
    _onbDisplayedLang = CURRENT_LANG === 'en' ? 'en' : 'fr';
